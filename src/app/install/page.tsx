...
import { 
  ...
  CheckCircle, AlertCircle, Github, ExternalLink,
  ArrowRight, Terminal, Code, Zap
} from 'lucide-react'
...
export default function InstallPage() {
  ...
  const userscriptUrl = 'https://raw.githubusercontent.com/yourusername/ipl-auction-arena/main/userscript/ipl-auction-arena.user.js'
  ...
  const steps = [
    {
      ...
      browsers: [
        { name: 'Chrome / Edge / Brave', icon: Chrome, url: 'https://chrome.google.com/webstore/detail/tampermonkey/dhdgffkkebhmkfjojejmpbldmpobfkfo' },
        { name: 'Firefox', icon: Firefox, url: 'https://addons.mozilla.org/en-US/firefox/addon/tampermonkey/' },
        { name: 'Safari', icon: Safari, url: 'https://apps.apple.com/app/tampermonkey/id1482490089' },
      ]
    },
    {
    ...
    <div className="min-h-screen bg-neutral-950 flex flex-col">
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-4 py-12">
            ...
            {steps.map((_, i) => (
              <div key={i} className="flex items-center">
                <div className={cn(
                  ...
                  i + 1 === step ? 'bg-amber-500 text-black ring-4 ring-amber-500/30' :
        ...
        <div className="animate-in fade-in slide-in-from-bottom-4">
          <div className="card p-8">
            ...
            <p className="text-neutral-400 mb-6 whitespace-pre-line">{steps[step - 1].desc}</p>
                ...
                {steps[0].browsers.map((browser, i) => (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-sm text-neutral-500">Click to install Tampermonkey</p>
                    </div>
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 bg-neutral-800/50 border border-neutral-700 rounded-xl text-sm text-neutral-400">
                  ...
                  <ol className="list-decimal list-inside space-y-1">
                    ...
                    <li>Click <span className="font-medium text-amber-400">Install</span></li>
                ...
                {!installed && (
                  <p className="text-center text-neutral-500 text-sm">
                    Already installed? <button onClick={() => setStep(3)} className="text-amber-400 hover:underline">Continue →</button>
                  </p>
                )}
              </div>
            )}
            ...
            {step === 3 && (
              <div className="space-y-6">
                ...
                <Link href="/" className="btn-primary w-full py-4 text-lg flex items-center justify-center gap-3">
                ...
                <div className="pt-6 border-t border-neutral-800">
                  ...
                  <ol className="list-decimal list-inside space-y-2 text-neutral-400 text-sm">
                    ...
                    <li>Share the room link (e.g., <code className="bg-neutral-800 px-1 rounded">arena.app/room/9TM8LF</code>) with friends</li>
        ...
        <div className="mt-10 p-6 bg-neutral-900/50 border border-neutral-800 rounded-xl">
          ...
          <div className="grid md:grid-cols-2 gap-4 text-sm text-neutral-400">
            <div className="p-4 bg-neutral-800/50 rounded-lg font-mono text-white">
              <span className="text-green-400">// ==UserScript==</span><br/>
              <span className="text-amber-400">@name</span> IPL Auction Arena Exporter<br/>
              <span className="text-amber-400">@match</span> https://www.playauctiongame.com/room/*<br/>
              <span className="text-amber-400">@grant</span> GM_xmlhttpRequest<br/>
              <span className="text-amber-400">@connect</span> arena.app<br/>
            ...
            <div className="p-4 bg-neutral-800/50 rounded-lg">
              ...
              <ul className="list-disc list-inside space-y-1">
                ...
                <li>Posts data to <code className="bg-neutral-800 px-1 rounded">/api/import-room</code></li>
      ...
      <footer className="py-8 px-4 border-t border-neutral-800">
        <div className="max-w-4xl mx-auto text-center text-neutral-500 text-sm">
          Only the <strong className="text-white">HOST</strong> needs this userscript. Friends just join via room link.
        </div>
      </footer>
    </div>
  )
