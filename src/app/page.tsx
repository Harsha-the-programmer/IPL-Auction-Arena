      ...
      <section className="relative overflow-hidden py-20 lg:py-32 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="absolute inset-0 -z-10 overflow-hidden">
            ...
            <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-orange-500/10 rounded-full blur-3xl animate-pulse-slow" style={{ animationDelay: '1s' }} />
          </div>
          ...
          <div className="space-y-8 animate-in fade-in duration-700">
            ...
            <p className="text-lg lg:text-xl text-neutral-400 max-w-2xl mx-auto leading-relaxed">
              Turn your auction squads into playing XI battles. 
              Import teams, build lineups, and compete in AI-ranked faceoffs.
            </p>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
              <input
                ...
                autoFocus
              />
              <button type="submit" disabled={roomCode.length !== 6} className="btn-primary whitespace-nowrap">
            ...
            <p className="text-sm text-neutral-500">
              ...
              <Link href="/install" className="text-amber-400 hover:underline font-medium">
      ...
      <section className="py-20 px-4 border-t border-neutral-800">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { icon: Zap, title: 'Real-time Multiplayer', desc: 'Socket.io powered. Everyone sees reveals simultaneously.' },
              { icon: Shield, title: 'Host Approval', desc: 'Host approves team claims. No wrong team selections.' },
              { icon: Trophy, title: 'Progressive Locking', desc: 'Lock position 1, then 2... AI ranks, points auto-calculated.' },
              { icon: Code, title: 'Free & Open', desc: 'Tampermonkey userscript. No Chrome Store fee. Works everywhere.' },
            ].map((feature, i) => (
      ...
      <section className="py-20 px-4 border-t border-neutral-800">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-neutral-400 mb-8">
            Install the userscript, finish your auction, and let the real competition begin.
          </p>
          <Link href="/install" className="btn-primary text-lg px-8 py-3 inline-flex items-center gap-2">
      ...
      <footer className="py-8 px-4 border-t border-neutral-800">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-neutral-500 text-sm">
            Not affiliated with playauctiongame.com or IPL. Fan project for friends.
          </p>
          <div className="flex items-center gap-4">
            <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-neutral-500 hover:text-amber-400 transition-colors">
